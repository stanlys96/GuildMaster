...
import { ShoppingCart, Star, Heart, Filter, Search, Grid, List } from 'lucide-react';
  ...
  const storeProducts = [
    {
      ...
      vtuber: 'Aria Skywind',
      description: 'Premium cotton t-shirt featuring Aria\'s signature design with mystical skywind patterns'
    },
    {
      id: 'prod-2',
      ...
      guild: 'The Skyward Sentinels',
      vtuber: 'Aria Skywind',
      description: 'Exclusive digital artwork collection featuring ethereal landscapes and character art'
    },
    {
      id: 'prod-3',
      ...
      description: 'Cozy hoodie with glow-in-the-dark lunar patterns and constellation designs'
    },
    {
      id: 'prod-4',
      ...
      description: 'High-performance gaming mouse with RGB lighting and custom Kai Thunderbolt design'
    },
    {
      id: 'prod-5',
      ...
      description: 'Handcrafted crystal necklace with mystical properties and Nova\'s blessing'
    },
    {
      id: 'prod-6',
      ...
      description: 'Set of 3 premium art prints featuring Zara\'s most iconic phoenix transformations'
    },
    {
      id: 'prod-7',
      ...
      description: 'Mysterious mask worn by Echo during special stealth missions and ceremonies'
    },
    {
      id: 'prod-8',
      ...
      guild: 'The Skyward Sentinels',
      vtuber: 'Aria Skywind',
      description: 'Exclusive music album NFT with bonus tracks, behind-the-scenes content, and artwork'
    }
  ];

  const categories = ['All', 'Apparel', 'Digital Art', 'Gaming Gear', 'Accessories', 'Art Prints', 'Music'];
  ...
  return (
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">GuildMasters Store</h1>
          <p className="text-gray-400">Discover exclusive merchandise from your favorite Vtubers and guilds</p>
        </div>
              ...
              <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-accent-purple text-sm font-medium">{product.vtuber} • {product.guild}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <span className="text-white font-bold text-xl">{product.price} ETH</span>
                    {product.originalPrice && (
                      <span className="text-gray-500 text-sm line-through">{product.originalPrice} ETH</span>
                    )}
                  </div>
                  <button
                  ...
                  >
                    ...
                    <span>
                      {!isConnected ? 'Connect Wallet' : !product.inStock ? 'Sold Out' : 'Add to Cart'}
                    </span>
                  </button>
                </div>
              </div>
