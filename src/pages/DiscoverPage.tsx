...
const DiscoverPage: React.FC = () => {
  ...
  useEffect(() => {
    const sectionsToShow =
      document.querySelectorAll<HTMLElement>(".show-navbar");
    ...
    sectionsToShow.forEach((section) => observer.observe(section));
          ...
          <div className="grid grid-cols-2 gap-4 text-white">
            <div className="flex flex-col gap-y-2 px-16">
              ...
              <p className="text-white/50">
                Supporters can support creators through many payment methods,
                from e-wallets to bank online transfer. The easier it is for
                supporters to make payment, the more chances the creators will
                get support.
              </p>
        ...
        <section className="py-16 bg-surface/30 px-16 text-white">
          <div className="rounded-md bg-[#204D83] p-16 flex gap-x-2">
            <div className="flex flex-col gap-y-5">
              ...
              <p>
                Gabung di Trakteer, monetisasi karya kreatifmu, dan mulai
                hasilkan uang dengan mudah! Manfaatkan platform kami untuk
